...
// ⚠️ NOTA: El toast flotante está comentado aquí porque ya se usa SweetAlerts 
// y el toast no tenía su propia lógica de ocultación. Se usará solo Swal.fire.
        ...
        try {
            const res = await axios.post(
                "http://localhost:3000/api/auth/registro",
                {
                    ...
                    email: data.email,
                    contrasena: data.contraseña, // El backend espera 'contrasena' (sin ñ)
                    telefono: data.telefono,
                }
            );

            // Éxito: Muestra SweetAlert, resetea y cierra modal
            Swal.fire({
            ...
            // Opcional: Si el equipo quiere auto-loguear al usuario, se haría un dispatch aquí.
            ...
            const msg = error.response?.data?.Error || "Error desconocido en el servidor.";
            setErrorMessage(msg); // Muestra el mensaje de error en el modal
            ...
            setIsLoading(false); // Desactiva el spinner siempre
        }
    };

    return (
        <>
            {/* ❌ ELIMINADO: El div de notificación flotante (toast) se ha eliminado */}
                            ...
                            <Controller
                                ...
                                rules={{
                                    ...
                                    validate: (value, formValues) => {
                                        return value === formValues.contraseña || 'Las contraseñas no coinciden';
                                    }
                                }}
                                render={({ field }) => (
                                    <>
